...
> **Scale target (MM, 2026-07-02; see design.md "Scale target"):
...
- [ ] **Definition-vs-visibility for namespace scans** (found designing
  ...
  [remakefile_deps.md](designs/remakefile_deps.md)): `load_remake` errors on an
...
- [ ] **Per-task log total-file-count budget** — the sharded
  ...
  open question in design_docs/designs/per_task_logging.md.

## SLURM

The 2026-07-09 submission-logic review cluster and the deferrable-rules
check were closed 2026-07-10 and pruned to
[todos_archive.md](records/todos_archive.md) at the 0.8.1 release (parked designs
and rationale: [slurm_already_running.md](designs/slurm_already_running.md)).
...
- [ ] **Missing external inputs: fail fast with a hint** (scoped as
  0.9.0 item 6, spec in
  [releases/v0.9.0.md](releases/v0.9.0.md)): running a
